			...
			<form action="">
				<table class="Btable" id="writeTable" border="1">
					...
					<tr>
						<td class="hc">작성자</td>
						<td colspan="3">
							<input type="text" class="BdetailInfo" id="seller">
							<input type="text" name="nick" class="BdetailInfo" id="nick" value="${user.nick}">
							<input type="hidden" name="id" class="BdetailInfo" id="id" value="${user.id}">
						</td>
					</tr>
					<tr>
						<td class="hc">카테고리</td>
					...
					<tr>
						...
						<td colspan="3"><textarea rows="30" cols="100" name="content" class="BdetailInfo" id="content"></textarea></td>
					</tr>
					<tr id="trPreview">
